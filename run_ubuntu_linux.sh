...
-drive file=imgs/ubuntu-image-new.img,if=none,id=drive0,cache=writeback -device virtio-blk-device,indirect_desc=false,event_idx=false,drive=drive0,bootindex=0 \
-nic none \
